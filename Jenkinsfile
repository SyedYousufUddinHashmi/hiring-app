            ...
            steps {
                script{
                    withCredentials([string(credentialsId: 'githubtoken', variable: 'GIT_TOKEN')]) { 
                        sh '''
                        git config --global user.email yousufhashmi6514@outlook.com
                        ...
                        git remote -v
                        git push https://$GIT_USERNAME:$GIT_PASSWORD@github.com/SyedYousufUddinHashmi/Hiring-app-argocd1.git main
                        '''                        
                      }
                  }
            }   
